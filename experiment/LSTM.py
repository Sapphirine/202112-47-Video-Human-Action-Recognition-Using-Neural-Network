...
def LSTM_Model(X):
    ...
    layer1 = tf.contrib.rnn.BasicLSTMCell(hidden_number, forget_bias=1.0)
    layer2 = tf.contrib.rnn.BasicLSTMCell(hidden_number, forget_bias=1.0)
    layer3 = tf.contrib.rnn.BasicLSTMCell(hidden_number, forget_bias=1.0)
